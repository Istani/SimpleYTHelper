...
if(in_array($_tmp_tabellename, $check_table)) {
  $db_subs = $database->sql_select($_tmp_tabellename, "*", "token_id='".$_SESSION['token']['id']."' AND channel_id='".$_SESSION['token']['channel_id']."' AND `ignore`=0 ORDER BY first_seen DESC LIMIT 1",true);
