<?php
// Cronjob
$_tmp_tabellename=strtolower("videos_status");
...
if ($tt["last_used"]+$tt["cooldown"]<time()) {
  ...
  if ($tt["token"] == "null") {
    ...
    $listRequests = $database->sql_select("videos_snippet","videoId", "`ignore`=0 ORDER BY last_statusupdate LIMIT ".$req_count, true);
  } else {
